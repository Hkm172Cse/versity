...
<body>
    <div class="hero">
        ...
        <form id="login" action="<?= base_url()?>login_lucc_admin" method="post" class="input-group">
        ...
        <form action="<?php echo base_url()?>registation_lucc" method="post" id="register" class="input-group">
            
            <input type="hidden" name="group_name" value="LUCC" class="input-field">

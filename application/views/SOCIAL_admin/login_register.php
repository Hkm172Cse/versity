...
<body>
    <div class="hero">
        ...
        <?= $this->session->flashdata('social_valid_email');?>

        <form id="login" action="<?= base_url()?>login_social_admin" method="post" class="input-group">
        ...
        <form action="<?php echo base_url()?>registation_social" method="post" id="register" class="input-group">
            
            <input type="hidden" name="group_name" value="social_group" class="input-field">

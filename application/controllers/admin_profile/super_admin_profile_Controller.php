...
class super_admin_profile_Controller extends CI_Controller {
	public function __construct(){
        ...
        if(!$this->session->has_userdata('super_admin')){
    ...
    public function index(){
        ...
        $profile_info   = $this->session->userdata('super_admin');
        $data['profile_data'] = $this->LUDC_Model->profile_login($profile_info);
        $this->load->view('admin_profiles/super_admin_profile', $data);
    }

<?php
    class LUCC_Model extends CI_Model {
        ...
        public function insert_entry($data)
        {
              ...
              return $this->db->insert('table_lucc_users', $data);
        }
        ...
        public function select_all_user(){
            $query = $this->db->query("select * from table_user where group_name = 'LUCC' order by id DESC");
            return $query->result();
        }
